...
const tool = {
  ...
  title: 'Case Converter Online Free — Convert Text Case Instantly',
  description: 'Free online case converter tool. Convert text to uppercase, lowercase, title case, camel case and more instantly. No signup needed.',
  keywords: 'case converter, uppercase, lowercase, title case, camel case, pascal case, snake case, kebab case, text tool, online converter',
};
          ...
          <Card className="shadow-2xl border-slate-700 bg-slate-900 rounded-[20px] overflow-hidden">
            <CardHeader className="text-center bg-slate-800/50 p-8 pb-10 relative">
               <div className="mx-auto w-fit p-5 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl mb-4 shadow-lg shadow-blue-500/20">
                  <CaseSensitive className="w-10 h-10 text-white" />
               </div>

...
const tool = {
  ...
  title: 'Color Picker Online Free — Pick Colors & Generate Palettes Instantly',
  description: 'Free online color picker tool. Pick any color, get HEX, RGB, HSL codes and generate beautiful color palettes instantly. No signup needed.',
  keywords: 'color picker, palette generator, hex code, rgb to hex, hsl colors, monochromatic palette, triadic colors, complementary colors, random palette',
};

...
const tool = {
  ...
  title: 'Pomodoro Timer Online Free — Boost Productivity with Focus Timer',
  description: 'Free online Pomodoro timer. Boost your productivity with 25 minute focus sessions and breaks. No signup needed.',
  keywords: 'pomodoro timer, focus timer, productivity tool, study timer, work timer, pomodoro technique, online timer',
};

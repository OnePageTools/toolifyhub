...
const tool = {
  ...
  description: 'Easily convert your PDF documents to editable Word (.docx) files. Our free tool works entirely in your browser, ensuring your files remain private.',
  keywords: 'pdf to word, pdf to docx, convert pdf to word, free pdf converter, online converter, pdf converter',
};
          ...
          <Card className="shadow-lg border-primary/20">
            <CardHeader className="text-center bg-secondary/50 p-8">
              ...
              <CardDescription className="text-lg mt-2">
                Convert your PDFs into editable Word documents, right in your browser.
              </CardDescription>
            </CardHeader>

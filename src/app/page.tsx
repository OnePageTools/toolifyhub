  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-background text-foreground transition-colors duration-300">
      ...
      <div className="relative z-10 flex flex-col">
        {/* Navbar */}
        <header className="flex items-center justify-between px-6 py-4 backdrop-blur-xl bg-background/80 sticky top-0 border-b border-border z-50 transition-colors">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-secondary hover:bg-secondary/80 transition-all border border-border"
            ...
            <Sheet>
              <SheetTrigger asChild>
                <Button variant="ghost" size="icon" className="p-2 rounded-xl bg-secondary md:hidden" aria-label="Open navigation menu">
        ...
        <div className="container mx-auto px-6 py-20 text-center relative">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary border border-border text-sm font-semibold text-blue-500 mb-8 shadow-sm"
          >
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-8xl font-black tracking-tighter leading-[0.9] mb-6 text-foreground"
          >
          ...
          >
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="rounded-full px-10 h-14 bg-transparent border-border hover:bg-secondary"
          ...
          >
            {["35+ Tools", "100% Free", "No Signup"].map((stat) => (
                <div key={stat} className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/[0.05] border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-xs font-bold uppercase tracking-widest">
        ...
        {/* Stats Section */}
        <div className="w-full bg-secondary/30 border-y border-border py-12 mb-16">
        ...
        <div className="container mx-auto px-6 mb-12">
            <div className="max-w-3xl mx-auto relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full blur opacity-10 group-focus-within:opacity-20 transition duration-500"></div>
                <div className="relative flex items-center bg-card border border-border rounded-full px-6 h-16 shadow-sm">
                    ...
                    <input
                        ...
                        className="bg-transparent flex-1 outline-none text-lg placeholder:text-muted-foreground text-foreground"
                    />
                    <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-secondary border border-border text-[10px] font-bold text-muted-foreground">
          ...
          >
            {filteredTools.map((tool: Tool) => (
              ...
              >
                <Link
                  href={tool.href}
                  className="block h-auto md:h-full bg-card border border-border rounded-xl md:rounded-[20px] p-3 md:p-6 hover:bg-secondary/50 hover:border-primary/40 transition-all duration-300 shadow-sm"
                >
                  <div className="space-y-3 md:space-y-4 h-full flex flex-col">
                    ...
                    <div>
                      <h3 className="font-bold text-sm md:text-base text-foreground mb-0.5 md:mb-1.5">{tool.name}</h3>
                      <p className="text-[12px] md:text-[13px] text-muted-foreground leading-snug truncate md:line-clamp-2">{tool.description}</p>
                    </div>
                    <div className="md:mt-auto pt-1 md:pt-4 flex justify-end">
                        <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-secondary flex items-center justify-center transform translate-x-2 opacity-0 md:group-hover:translate-x-0 md:group-hover:opacity-100 transition-all duration-300">
        ...
        <section id="how-it-works" className="container mx-auto px-6 py-32 border-t border-border bg-secondary/10">
            <motion.div 
                initial={{ opacity: 0, y: 15 }}
            ...
            >
                <h2 className="text-4xl md:text-5xl font-black text-foreground mb-4 tracking-tight">How It Works</h2>
                <p className="text-muted-foreground text-lg max-w-xl mx-auto">Get started in seconds — no signup, no download required</p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                {[
                    ...
                    >
                        <div className="bg-card border border-border rounded-[32px] p-8 h-full hover:bg-secondary/50 transition-all duration-300 shadow-sm">
                            <span className="text-5xl font-black text-foreground/5 absolute top-6 right-8 select-none">{step.num}</span>
                            <div className={cn(
                        ...
                        {i < 2 && (
                            <div className="hidden lg:block absolute -right-4 top-1/2 -translate-y-1/2 z-20 text-muted">

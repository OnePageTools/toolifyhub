  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-background text-foreground transition-colors duration-300">
      ...
      <div className="relative z-10 flex flex-col">
        {/* Navbar */}
        <header className="flex items-center justify-between px-6 py-4 backdrop-blur-xl bg-[#0A0F1E]/80 sticky top-0 border-b border-border z-50 transition-colors">
          ...
          <div className="flex items-center gap-4">
            <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-muted-foreground">
                <Link href="/" className="hover:text-foreground transition-colors text-foreground font-bold">Tools</Link>
        ...
        <div className="container mx-auto px-6 py-20 text-center relative">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary border border-border text-sm font-semibold text-blue-500 mb-8 shadow-sm">
            <Sparkles className="w-4 h-4" /> 50+ Free Tools — No Signup Required
          </div>
          
          <h1 className="text-5xl md:text-8xl font-black tracking-tighter leading-[0.9] mb-6 text-foreground">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            {["50+ Tools", "100% Free", "No Signup"].map((stat) => (
                <div key={stat} className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/[0.05] border border-emerald-500/20 text-emerald-400 text-xs font-bold uppercase tracking-widest shadow-sm">
        ...
        <div id="search-section" className="container mx-auto px-6 mb-12">
            <div className="max-w-3xl mx-auto relative group">
                ...
                <div className="relative flex items-center bg-card border border-border rounded-full px-6 h-16 shadow-none">
                    ...
                    <input
                        ...
                        className="bg-transparent flex-1 outline-none text-lg placeholder:text-slate-400 text-foreground"
                    />
          ...
          >
            {filteredTools.map((tool: Tool) => (
              ...
              >
                <Link
                  href={tool.href}
                  className="block h-auto md:h-full bg-card border border-border rounded-xl md:rounded-[20px] p-3 md:p-6 hover:bg-secondary/50 hover:border-primary/40 transition-all duration-300 shadow-sm hover:shadow-none"
                >
        ...
        <section id="how-it-works" className="container mx-auto px-6 py-32 border-t border-border bg-secondary/10">
            <div className="text-center mb-20">
                ...
                <p className="text-muted-foreground text-lg max-xl mx-auto">Get started in seconds — no signup, no download required</p>
            </div>

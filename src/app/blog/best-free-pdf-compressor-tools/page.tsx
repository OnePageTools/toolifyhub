...
export default function BlogPost() {
  return (
    <PostLayout title={post.title}>
      ...
      <p>
        In 2026, security and privacy are paramount. You shouldn't have to upload a sensitive document to an unknown server just to make it smaller. We've reviewed the best free PDF compressors, focusing on tools that are secure, easy to use, and deliver great results.
      </p>
      ...
      <p>
        The free usage is also limited, and it operates by uploading your files to its servers. One of its strengths is its integration with Google Drive and Dropbox, which can be convenient for cloud users. It's a solid all-around choice, but the privacy-conscious may prefer a client-side solution.
      </p>
